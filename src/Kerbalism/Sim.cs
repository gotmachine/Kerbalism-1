	...
	public static class Sim
	{
		...
		public static double AtmosphereFactorAnalytic(CelestialBody body, Vector3d position, Vector3d sun_dir)
		{
			...
			if (static_pressure > 0.0)
			{
				...
				LineRenderer.CommitWorldVector(position, sun_dir, 5000f, Color.yellow);
				LineRenderer.CommitWorldVector(position, sunDirs[0], 5000f, Color.blue);
				LineRenderer.CommitWorldVector(position, sunDirs[1], 5000f, Color.red);
